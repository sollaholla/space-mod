...
namespace BaseBuilding.Resources
{
    public class Resource
    {
        ...
        /// <param name="amountCheck">
        ///     If true, then we will check if the player has the same amount of this
        ///     resource as the resource itself has.
        /// </param>
        /// <returns></returns>
        public static bool DoesHaveResource(Resource resource, List<PlayerResource> playersResources,
        ...
        /// <returns></returns>
        public static List<Resource> GetRemainingResourcesRequired(ObjectInfo buildableObjectInfo,
            List<PlayerResource> playersResources)
        {
