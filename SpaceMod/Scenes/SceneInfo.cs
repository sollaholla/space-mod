...
[System.Serializable]
public partial class SurfaceInfo : IDrawable
{
    [Category("Required"), Description("The name of the ydr/ydd model. Example: 'earth_large'"), RefreshProperties(RefreshProperties.All)]
    public string Model { get; set; }
    ...
    [Category("Settings"), Description("True if you want this surface to tile infinitely. WARNING: Your model should be seamless on each edge.")]
    public bool Tile { get; set; }

    [Category("Settings"), Description("The size of your terrain in meters. 1024 is the default scale. This will affect how far your terrain tiles are generated from the parent terrain tile.")]
...
{
    [Description("True if you want this point to have a blip."), RefreshProperties(RefreshProperties.All)]
    ...
    [Description("Set the heading of the player after going from 'Start' to 'End'."), RefreshProperties(RefreshProperties.All)]
